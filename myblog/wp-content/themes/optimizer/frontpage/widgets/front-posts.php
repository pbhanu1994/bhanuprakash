...
class optimizer_front_Posts extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['postbgcolor'] = $new_instance['postbgcolor'];
	...
	function form( $instance ) {
		...
		<p>
			...
			<input class="widefat" id="<?php echo $this->get_field_id( 'subtitle' ); ?>" name="<?php echo $this->get_field_name( 'subtitle' ); ?>" value="<?php echo $instance['subtitle']; ?>" type="text" />
		</p>
