...
class optimizer_front_Blocks extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$block1title = isset( $instance['block1title'] ) ? apply_filters('widget_title', $instance['block1title'] ) : __('Lorem Ipsum', 'optimizer');
		...
		$block2title = isset( $instance['block2title'] ) ? apply_filters('widget_title', $instance['block2title'] ) : __('Lorem Ipsum', 'optimizer');
		...
		$block3title = isset( $instance['block3title'] ) ? apply_filters('widget_title', $instance['block3title'] ) : __('Lorem Ipsum', 'optimizer');
		...
		$block4title = isset( $instance['block4title'] ) ? apply_filters('widget_title', $instance['block4title'] ) : '';
		...
		$block5title = isset( $instance['block5title'] ) ? apply_filters('widget_title', $instance['block5title'] ) : '';
		...
		$block6title = isset( $instance['block6title'] ) ? apply_filters('widget_title', $instance['block6title'] ) : '';
	...
	function form( $instance ) {
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block1title' ); ?>" name="<?php echo $this->get_field_name( 'block1title' ); ?>" value="<?php echo $instance['block1title']; ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block2title' ); ?>" name="<?php echo $this->get_field_name( 'block2title' ); ?>" value="<?php echo $instance['block2title']; ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block3title' ); ?>" name="<?php echo $this->get_field_name( 'block3title' ); ?>" value="<?php echo $instance['block3title']; ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block4title' ); ?>" name="<?php echo $this->get_field_name( 'block4title' ); ?>" value="<?php echo $instance['block4title']; ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block5title' ); ?>" name="<?php echo $this->get_field_name( 'block5title' ); ?>" value="<?php echo $instance['block5title']; ?>" type="text" />
                </p>
        ...
        <div class="block_accordion">
            ...
            <div class="block_acc_wrap">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'block6title' ); ?>" name="<?php echo $this->get_field_name( 'block6title' ); ?>" value="<?php echo $instance['block6title']; ?>" type="text" />
                </p>
