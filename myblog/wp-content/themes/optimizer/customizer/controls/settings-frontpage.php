...
$wp_customize->add_setting( 'optimizer[static_img_text_id]', array(
        ...
        'default' => '<p style="text-align: center;"><img class="aligncenter size-full wp-image-10751" src="'. get_template_directory_uri().'/assets/images/slide_icon.png" alt="slide_icon" width="100" height="100" /></p><p style="text-align: center;"><span style="font-size: 36pt;">ADVANCED . <strong>STRONG</strong> . RELIABLE</span></p><p style="text-align: center;">The Optimizer, an easy to customizable multi-purpose theme with lots of powerful features.</p>',
