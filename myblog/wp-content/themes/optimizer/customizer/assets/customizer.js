...
jQuery(window).bind('load', function(){
	...
	jQuery('.logo_control_tabs li.imglogo a').click(function(){ 
		...
		cta1controls.hide();
		jQuery('.control_cta1_title').toggle(function() {    cta1controls.show();   },function(){    cta1controls.hide();   });
		cta2controls.hide();
		jQuery('.control_cta2_title').toggle(function() {    cta2controls.show();   },function(){    cta2controls.hide();   });
	...
	if(currentslider == 'accordion' || currentslider == 'nivo' || currentslider == 'noslider'){  staticontrols.css({"display":"none"});  }
	if(currentslider == 'static' || currentslider == 'noslider'){  nivoaccordion.css({"display":"none"});  }
	
	jQuery('#customize-control-slider_type_id select').on('change', function(){ 
		if(jQuery(this).find('option:selected').val() == 'static'){
			jQuery('#customize-control-static_image_id').attr('style', 'display:list-item!important;')
			nivoaccordion.fadeOut(600);
			staticontrols.delay(600).fadeIn(600);
		}
		if(jQuery(this).find('option:selected').val() == 'accordion' || jQuery(this).find('option:selected').val() == 'nivo'){
			...
			staticontrols.fadeOut(600);
			staticontrols2.fadeOut(600).removeClass('activebgoption');
			nivoaccordion.delay(600).fadeIn(600);
		}
