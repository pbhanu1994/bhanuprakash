...
function optimizer_option_defaults() {
	$defaults = array(
		...
		'slider_txt_hide' => '',
		'static_img_text_id' => '<p style="text-align: center;"><img class="aligncenter size-full wp-image-10751" src="'. get_template_directory_uri().'/assets/images/slide_icon.png" alt="slide_icon" width="100" height="100" /></p><p style="text-align: center;"><span style="font-size: 36pt;">'.__('ADVANCED','optimizer').' . <strong>'.__('STRONG', 'optimizer').'</strong> . '.__('RELIABLE', 'optimizer').'</span></p><p style="text-align: center;">'.__('The Optimizer, an easy to customizable multi-purpose theme with lots of powerful features.', 'optimizer').'</p>',
