          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __(  CONVAC_LITE_ADMIN_MENU_NAME.' Options', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __(  CONVAC_LITE_ADMIN_MENU_NAME.' Options', 'option-tree' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( CONVAC_LITE_ADMIN_MENU_NAME.' Options updated.', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( CONVAC_LITE_ADMIN_MENU_NAME.' Options reset.', 'option-tree' ) ),
