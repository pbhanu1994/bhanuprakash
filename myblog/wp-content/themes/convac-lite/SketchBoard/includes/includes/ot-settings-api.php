    ...
    public function display_page() {
      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          $sktlink = "http://www.sketchthemes.com/themes/convac-responsive-multi-author-blogging-theme/";
			    $sktratelink = "http://wordpress.org/support/view/theme-reviews/convac-lite";
          $skttest_drive = "http://trial.sketchthemes.com/wp-signup.php";
            
            echo '	<div class="donate-info">
					<strong>'. __( "To Activate All Features, Please Upgrade to Pro version!", "convac-lite" ) .'</strong><br/>
					<a title="'. __( "Upgrade to Pro", "convac-lite" ) .'" href="'. esc_url($sktlink) .'" target="_blank" class="upgrade">'. __( "Upgrade to Pro", "convac-lite" ) .'</a>	<a title="'. __( 'Setup Instructions', 'convac-lite' ) .'" href="'. get_template_directory_uri().'/Installation_Instructions.txt' .'" target="_blank" class="donate">'. __( 'Setup Instructions', 'convac-lite' ) .'</a>
					<a title="'. __( 'Rate convac Lite', 'convac-lite' ) .'" href="'. esc_url($sktratelink) .'" target="_blank" class="review">'. __( 'Rate convac Lite', 'convac-lite' ) .'</a>
					<a title="'. __( 'Test Drive', 'convac-lite' ) .'" href="'. esc_url($skttest_drive) .'" target="_blank" class="review">'. __( 'Theme Test Drive', 'convac-lite' ) .'</a>
          <div id="social-share">
					<div class="fb-like">
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-version"><span>Version ' . CONVAC_LITE_THEME_VERSION . '</span></li>';
